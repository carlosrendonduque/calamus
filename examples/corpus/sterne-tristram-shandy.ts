 ...
 * (1759-1767), Volume I, Chapter XXII, complete.
 *
 * Public domain. Transcribed from Project Gutenberg eBook #1079:
 * https://www.gutenberg.org/ebooks/1079
 *
 * Only two mechanical changes were made to the Gutenberg text: the hard line
 * wrapping was removed so each paragraph is a single string, and the plain-text
 * `_underscore_` italic markers were dropped, because `ReaderContent.body`
 * carries unstyled text. Spelling, punctuation and Sterne's dashes are as
 * printed.
 */
export const tristramShandy: ReaderContent = {
  title: "The Life and Opinions of Tristram Shandy, Gentleman",
  subtitle: "vol-i-chap-xxii.txt",
  body: [
